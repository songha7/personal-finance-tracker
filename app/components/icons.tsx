// Hand-rolled nav/UI icons.
//
// The app has no icon library installed, and pulling one in just for ~12
// glyphs would be a heavier dependency than the problem needs. Every icon
// here is a plain 24x24 stroke-based SVG (2px stroke, round caps/joins —
// the same "feather-style" look most icon sets use), so they read as one
// consistent family. `size`/`className` pass through so callers can color
// them with `currentColor` via Tailwind text-* classes.
...
export function TransactionsIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function BudgetsIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function TrendUpIcon({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function TrendDownIcon({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M3 7l7 7 4-4 7 7M15 17h6v-6" />
    </svg>
  );
}
